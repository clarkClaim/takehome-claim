...
If you select a "Large Feature", you should focus on delivering part or all of an MVP solution, with a short description of how you would improve your solution with more time. If you are not able to fully complete the feature, focus on creating a clean, readable, and maintainable progress that would be easy to complete with more time, and that still correctly compiles and runs.
...
1. Review the Project Outline and Development sections for context, definitions, and dev commands.

2. Read the Takehome section, and choose one of the features to implement.

## Project Outline

![Claim Schema Diagram](./claim-schema.png)
